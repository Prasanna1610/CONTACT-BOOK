...
def add_contact():
    ...
    def save():
        ...
        if(os.path.exists('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)):
            k=Label(scr1,text="    Contact already exist       ",font=("Arial Bold",20),fg="red")
            k.place(x=75,y=400)
            return
        fp=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname,"w")
        fp.write(name_entry+"\n")
        fp.write(num_entry)
        fp.close()
...
def search():
    ...
    def seaname():
        un=username.get()
        if (os.path.exists('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+un+'.txt')):
            file=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+un+'.txt','r')
            name=file.readline()
...
def edit():
    ...
    def edit_name():
        ...
        fname=un+".txt"
        if (os.path.exists('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)):
            file=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname,'r')
            nw=newname.get()
            nwfname=nw+".txt"
            name=file.readline()
            number=file.readline()
            fp=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+nwfname,"w")
            fp.write(nw+"\n")
            fp.write(number)
            file.close()
            os.remove('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)
    ...
    def edit_number():
        ...
        if (os.path.exists('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)):
            ...
            file.close()
            os.remove('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)
            file=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname,"w")
            file.write(un+"\n")
            file.write(number)
            file.close()
...
def del_contact():
    ...
    def delete():
        name_entry=name.get()
        fname=name_entry+".txt"
        if(os.path.exists('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+fname)==False):
...
def view():
    ...
    i=0
    for file in os.listdir('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'):
        i=i+1
        
        if (file.endswith(".txt")):
            fp=open('C:\\Users\\vamsi pilla\\Desktop\\contact\\all\\'+file,'r')
            name=fp.readline()
            num=fp.readline()
